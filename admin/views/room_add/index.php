<?php
require_once "./public/php/admin/room_add/index.php";
?>
        ...
        <div class="col-12 col-md-10 container-right p-5">
            ...
            <form enctype="multipart/form-data" method="post" action="">
                ...
                <div class="row mb-3">
                    ...
                    <input required type="text" name="name" class="form-control" id="message-text"></input>
                </div>
                <div class="seat-choose" id="seat-generate">
                    <div class="row generate">
                        <input required name="seat-row" type="number" class="col-3 form-control" id="seat-row" placeholder="Tổng hàng ghế">
                        <input required name="seat-col" type="number" class="col-3 form-control" id="seat-col" placeholder="Tổng cột ghế">
                        <button type="button" class="btn btn-danger col-3" onclick="seatGenerate()">Chọn loại ghế</button>
                    </div>
                ...
                <div class="row mb-3">
                    <button class="btn btn-primary" type="submit" name="addItemSeat" value="add">ADD</button>
                </div>
            </form>
        </div>
    </div>
